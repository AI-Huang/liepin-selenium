...
from .config import (MAX_WAIT_TIME, OUTPUT_FILENAME, PROCESSED_DATA_DIR,
                     SCROLL_DELAY, URL)
...
class LiepinCrawler:
    ...
    def save_to_file(self, filename=None):
        ...
        return output_path        print(f"\nData saved to: {output_path}")
        return output_path        PROCESSED_DATA_DIR.mkdir(parents=True, exist_ok=True)
